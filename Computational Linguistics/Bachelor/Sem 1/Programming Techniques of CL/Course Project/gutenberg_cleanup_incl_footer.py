...
# author: Mert Erol, Andrea Scheck
...
#### MODIFY HERE ####
#DONE: Make a function to really remove the footers
...
def main():
    ...
    with open(file_path, "r", encoding = "utf-8") as file:
        ...
        # 2. Clean the text
        cleaned_text_headers = strip_headers(text)
        print("Removed the headers")
        cleaned_text = strip_footers(cleaned_text_headers)
        print("Removed the footers")
